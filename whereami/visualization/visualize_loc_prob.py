...
python -m whereami.visualization.visualize_loc_prob --root $RSCAN_ROOT --graphs $WHEREAMI_DATA_ROOT/processed_data --top_k 5 --show_heatmap --show_3d
...
from whereami.data_processing.scene_graph import SceneGraph                    # noqa: E402
from whereami.analysis.helper import get_matching_subgraph  # noqa: E402
